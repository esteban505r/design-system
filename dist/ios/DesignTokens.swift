...
public class {
    ...
    public static let colorGradientAuth = linear-gradient(to bottom right, #C2410C, #7C2D12)
    ...
    public static let colorSurfaceBackground = UIColor(red: 0.102, green: 0.059, blue: 0.031, alpha: 1)
