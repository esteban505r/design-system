...
public class {
    ...
    public static let colorBrandPrimaryTint15 = UIColor(red: 0.388, green: 0.400, blue: 0.945, alpha: 0.15)
    ...
    public static let colorGradientAuth = linear-gradient(to bottom right, #4338CA, #6B21A8)
